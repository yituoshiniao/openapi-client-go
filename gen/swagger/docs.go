// Code generated by swaggo/swag at 2024-05-09 18:09:31.009602 +0800 CST m=+1.774846917. DO NOT EDIT.
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "请求成功",
                        "schema": {
                            "$ref": "#/definitions/internal_api_http_dto.ExampleGetResponse"
                        }
                    }
                }
            }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "请求成功",
                        "schema": {
                            "$ref": "#/definitions/internal_api_http_dto.ExampleGetOneResponse"
                        }
                    }
                }
            }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api_http_dto.ExamplePostRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "请求成功",
                        "schema": {
                            "$ref": "#/definitions/internal_api_http_dto.ExamplePostResponse"
                        },
                        "headers": {
                            "Location": {
                                "type": "string",
    ...
    "definitions": {
        "internal_api_http_dto.ExampleGetOneResponse": {
            ...
            "properties": {
                ...
                "data": {
                    "$ref": "#/definitions/internal_api_http_dto.UserPortraitData"
                },
                "msg": {
                    "description": "错误消息",
                    "type": "string",
        ...
        "internal_api_http_dto.ExamplePostRequest": {
            "type": "object",
            "required": [
                "app_id",
                "c_ver",
        ...
        "internal_api_http_dto.ExamplePostResponse": {
            "type": "object",
            "required": [
                "code",
                "data",
        ...
        "internal_api_http_dto.UserPortraitData": {
            "type": "object",
            "properties": {
                "country": {
                    "description": "国家",
